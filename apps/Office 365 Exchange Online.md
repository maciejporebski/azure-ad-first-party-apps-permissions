...
| Exchange.AdminAPI.ManageAsApp | 95930782-af91-4e2e-89b7-e34ce33a0450 | Manage Exchange Online Admin API as App | Allows the app to manage a limited set of Exchange Online configuration objects without user interaction, for specific scenarios supported by the adminapi/v2.0 endpoint. To enable management actions an admin must also assign the appropriate Exchange RBAC roles directly to the app. This permission replaces the previous Exchange.ManageAsAppV2 permission. |
...
| Exchange.ManageAsAppV2 | ea3d980d-ebc7-4be4-8298-a167e5b8797c | Manage Exchange as application v2 | Allows the app to manage a limited set of Exchange Online configuration objects without user interaction, for specific scenarios supported by the adminapi/v2.0 endpoint. To enable management actions an admin must also assign the appropriate Exchange RBAC roles directly to the app. |
...
| Exchange.AdminAPI.Manage | 9f021f4d-e924-4317-bf46-8db5e8340c6c | Manage Exchange Online Admin API | Allows the app to manage a limited set of Exchange Online configuration objects via the adminapi/v2.0 endpoint. This permission is intended for specific scenarios and requires appropriate Exchange RBAC role assignments. This permission replaces the previous Exchange.ManageV2 permission. |
...
| Exchange.ManageV2 | 44d6b5f2-d42b-4fa7-b999-1c5fcab98e4d | Manage Exchange configuration v2 | Allows the app to manage a limited set of Exchange Online configuration objects via the adminapi/v2.0 endpoint. This permission is intended for specific scenarios and requires appropriate Exchange RBAC role assignments. |
