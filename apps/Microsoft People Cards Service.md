...
| Chat.ReadWrite | 20abcb3c-0462-42ce-9fa0-d1c97a22f4e5 | Read and write chat messages (delegated) | Allow access to read and send chat messages via this API. |
...
| MCP.Read | 1c4fb7e0-1fa5-477b-a4b5-39592ebdf176 | Loki MCP Server Access | Loki MCP Server Access |
