...
| OneLake.Read.All | 547211ef-7223-404f-8519-fee52fda6402 | Make API calls that read OneLake definitions on all OneLake shortcuts | Allows the app to make API calls that read and write read OneLake definitions, on behalf of the signed-in user. |
| OneLake.ReadWrite.All | ada1b44b-4474-40ed-b32c-e3543dccec0e | Make API calls that read and write OneLake definitions on all OneLake shortcuts | Allows the app to make API calls that read and write read and write OneLake definitions, on behalf of the signed-in user. |
