...
| CatalogMirroring.Read.All | debb9ba3-fb14-491a-884c-b4406ac079f5 | Read Iceberg and Delta table catalog metadata from the provider | Allows reading Iceberg and Delta table catalog metadata from the external provider on the users behalf. |
...
| Fabric.Embed | 04994edc-428b-482b-af95-ee1575dde39b | Embed Fabric items, retrieve user identifiers and restricted metadata | Allows retrieving item definitions, user identifiers, and other restricted metadata required for embedding Fabric items on the user’s behalf. To embed, the app must also be granted the appropriate contextual scope(s), such as Item.Read.All, Notebook.Read.All, or Workspace.Read.All. |
