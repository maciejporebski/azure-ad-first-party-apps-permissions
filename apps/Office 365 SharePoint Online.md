...
| SharePointTenantSettings.Read.All | e370eb8e-f9cc-499d-90cc-7da62103e4f3 | Read SharePoint and OneDrive tenant settings | Allows the application to read the tenant-level settings of SharePoint and OneDrive, without a signed-in user. |
| SharePointTenantSettings.ReadWrite.All | 85bd96b3-dd7e-44d4-94f4-47fbb58e5718 | Read and change SharePoint and OneDrive tenant settings | Allows the application to read and change the tenant-level settings of SharePoint and OneDrive, without a signed-in user. |
...
| SharePointTenantSettings.Read.All | a9b72c67-36e4-4bef-b91f-dff5801f2270 | Read SharePoint and OneDrive tenant settings | Allows the application to read the tenant-level settings in SharePoint and OneDrive on behalf of the signed-in user. |
| SharePointTenantSettings.ReadWrite.All | aef0f52b-5892-4590-ae2c-d3f7928bd577 | Read and change SharePoint and OneDrive tenant settings | Allows the application to read and change the tenant-level settings of SharePoint and OneDrive on behalf of the signed-in user. |
